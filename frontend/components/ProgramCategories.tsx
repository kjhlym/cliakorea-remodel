    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 md:gap-6">
      {programCategories.map((program) => (
        <div key={program.id} className="flex flex-col">
          <Link
            href={program.href}
            className="group relative bg-white rounded-3xl p-5 md:p-6 shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-100 flex flex-col items-start text-left flex-grow"
          >
          ...
          {/* Action Button for 부모 리더십 - 교육 신청 */}
          {program.id === 3 && (
            <Link
              href="/apply"
              className="group relative bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white rounded-2xl p-6 transition-all shadow-lg hover:shadow-xl mt-8 overflow-hidden"
            >
          ...
          {/* Action Button for 특화 프로그램 - 온라인 상담 */}
          {program.id === 4 && (
            <Link
              href="/consultation"
              className="group relative bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 text-white rounded-2xl p-6 transition-all shadow-lg hover:shadow-xl mt-8 overflow-hidden"
            >
              <div className="flex items-center justify-between relative z-10">
                <div className="flex items-start gap-4">
                  <div className="bg-white/20 rounded-xl p-3 backdrop-blur-sm">
