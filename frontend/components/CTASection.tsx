  ...
  return (
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        <p className="text-sm md:text-xl text-blue-100 mb-8 md:mb-12 max-w-2xl mx-auto leading-relaxed break-keep">
        ...
        <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center">
          <Link
            ...
            className="px-6 py-3 md:px-10 md:py-4 bg-white text-blue-900 rounded-full font-bold text-base md:text-lg hover:shadow-[0_0_30px_rgba(255,255,255,0.4)] transition-all transform hover:scale-105"
          >
            강사 양성 과정 알아보기
          </Link>
          <Link
            href="/consultation"
            className="px-6 py-3 md:px-10 md:py-4 bg-transparent border-2 border-white/40 text-white rounded-full font-bold text-base md:text-lg hover:bg-white/10 transition-all"
          >
            교육 상담 신청
          </Link>
        </div>
