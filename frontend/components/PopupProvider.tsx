...
export default function PopupProvider() {
  ...
  return (
    <>
      ...
      {/* 팝업 카드 배열 컨테이너 (헤더 바로 밑에 배치) */}
      <div className="fixed top-14 md:top-20 left-0 right-0 bottom-0 z-[101] flex flex-wrap items-start justify-start gap-6 p-6 md:p-10 overflow-y-auto pointer-events-none">
