...
export default function ConsultationList() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-black text-gray-900">상담 내역 관리</h1>
          ...
          <tbody className="divide-y divide-gray-50">
            {data.map((con: any) => (
              <tr key={con.id} className="hover:bg-gray-50 transition-colors">
                <td className="px-6 py-4 font-bold text-gray-900">{con.name}</td>
                <td className="px-6 py-4 text-sm text-gray-500">{con.phone}</td>
                <td className="px-6 py-4 text-sm text-gray-500">{con.email}</td>
